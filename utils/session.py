...
class Session(object):
	...
	def clear(self):
		try:
			self._request_handler.redis.clear("sess_%s" % self.session_id)
		except Exception as e:
			logging.error(e)
		self._request_handler.clear_cookie('sess_%s' % self.session_id)
